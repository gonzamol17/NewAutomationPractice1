...
class TestCreateNewUserWithDictionary(BaseClass):

    def test_CreateNewUserWhitDictionary (self, getdata):
        driver = self.driver
        hp = HomePage(driver)
        time.sleep(3)
        hp.select_SignIn()
    ...
    @pytest.fixture(params=[{"gender":"Mr", "password":"Maestruli10", "day":"17", "month":"May",
                             "year": "1979", "firstname": "Nicolas", "lastname": "Molina", "address": "Luna 17",
                             "country": "Australia", "state": "Cordoba", "city": "Cordoba", "zip": "4354",
                             "mobile": "324323424"}])
